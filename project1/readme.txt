...
Then we use the formula as shown in reference (2) to get the weight vector with weight value of each word.
The words with highest weight value are considered first as good candidates for query expansion.
